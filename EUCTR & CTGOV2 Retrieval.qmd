...
# CTGOV2 Data (clinicaltrials.org)

```{r CTGOV2 database setup, include=TRUE}
...
```{r CTGOV2 test query, include=TRUE}

#Query 1: Using suggested original search criteria.

ctgovquery1 <- ctrGetQueryUrl("https://clinicaltrials.gov/search?cond=((((((((((((((Platform%20trial)%20OR%20(Platform%20trials))%20OR%20(trial%20platform))%20OR%20(Platform%20design))%20OR%20(platform%20study))%20OR%20(Platform%20clinical%20trial))%20OR%20(Adaptive%20platform))%20OR%20(Platform%20protocol))%20OR%20(MAMS))%20OR%20(Multi%20arm))%20OR%20(Umbrella%20trial))%20OR%20(Umbrella%20design))%20OR%20(basket%20trial))%20OR%20(basket%20design))%20OR%20(Dose%20expansion)&term=((((((((((((((Platform%20trial)%20OR%20(Platform%20trials))%20OR%20(trial%20platform))%20OR%20(Platform%20design))%20OR%20(platform%20study))%20OR%20(Platform%20clinical%20trial))%20OR%20(Adaptive%20platform))%20OR%20(Platform%20protocol))%20OR%20(MAMS))%20OR%20(Multi%20arm))%20OR%20(Umbrella%20trial))%20OR%20(Umbrella%20design))%20OR%20(basket%20trial))%20OR%20(basket%20design))%20OR%20(Dose%20expansion)&intr=((((((((((((((Platform%20trial)%20OR%20(Platform%20trials))%20OR%20(trial%20platform))%20OR%20(Platform%20design))%20OR%20(platform%20study))%20OR%20(Platform%20clinical%20trial))%20OR%20(Adaptive%20platform))%20OR%20(Platform%20protocol))%20OR%20(MAMS))%20OR%20(Multi%20arm))%20OR%20(Umbrella%20trial))%20OR%20(Umbrella%20design))%20OR%20(basket%20trial))%20OR%20(basket%20design))%20OR%20(Dose%20expansion)&start=2018-01-01_2024-12-31")


ctrOpenSearchPagesInBrowser(url = ctgovquery1)


ctrLoadQueryIntoDb(
  queryterm = ctgovquery1,
  con = db
)
...
CTRGOV2 <- dbGetFieldsIntoDf( fields = ".*", con = db)

#Save .xlsx file compiled from database into R data frames.

library(writexl)

write_xlsx(CTRGOV2, "C:/Users/jskinner/OneDrive - The Institute of Cancer Research/Desktop/Sabine/R/Sabine PhD Project/CTRGOV2 Duplicate.xlsx")
```
