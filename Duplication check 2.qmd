...
pubmed <- read_excel("Pubmed check 3.xlsx")
...
library(writexl)
write_xlsx(pubmed_cleaned, "pubmed_clean.xlsx")
write_xlsx(CTGOV_cleaned, "CTGOV_clean.xlsx")
write_xlsx(EUCTR_cleaned, "EUCTR_clean.xlsx")
